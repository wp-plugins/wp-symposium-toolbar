...
function symposium_toolbar_add_help_text( $contextual_help, $screen_id, $screen ) { 
	...
	case 'wp-symposium_page_wp-symposium-toolbar/wp-symposium-toolbar_admin' :
		...
		$help_content .= __('Next section, you may change the help_content of the WP User Menu, and pick the items you want to display to all users, registrered and logged-in.', 'wp-symposium-toolbar') . ' ' .
